...
export async function getConfig(): Promise<AppConfig> {
  ...
  return {
    llm: {
      ...
      request_timeout_seconds: llm.request_timeout_seconds ?? 120,
      enable_streaming: !!llm.enable_streaming,
      enable_web_search: !!llm.enable_web_search,
...
export async function saveConfig(cfg: AppConfig): Promise<void> {
  ...
  await app.SaveConfig({
    llm: {
      ...
      enable_streaming: cfg.llm.enable_streaming,
      enable_web_search: cfg.llm.enable_web_search,
